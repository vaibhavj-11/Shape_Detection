...
while True:
    ...
    for c in cnts:
        ...
        if len(approx) == 4:
            cv2.putText(img, "Rectangle", (x + w + 20, y + h + 20), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
        elif len(approx) == 3:
            cv2.putText(img, "Triangle", (x + w + 20, y + h + 20), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
        else:
            cv2.putText(img, "Circle", (x + w + 20, y + h + 20), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 255, 0), 1)
